...
const Page = ({ params }) => {
  ...
  const { data: restaurantMenu, isValidating: tableIsValidating, error } = useSWR(`${Endpoint.FETCH_MENU}?restaurant_id=${restaurantid}`, fetcher);
  ...
  const columns = [
    ...
    // {
    //   accessorKey: 'menu_image',
    //   header: 'Image',
    //   cell: info => {
    //     const imageUrl = info.getValue();
    //     return imageUrl ? <img src={imageUrl} alt="Menu" style={{ width: "100px", height: "auto" }} /> : 'No Image';
    //   }
    // },
    {
  ...
  return (
    <div className="bg-white shadow-xl rounded-md p-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold tracking-wide uppercase">Restaurant Menu</h1>
      </div>
      <Card className="">
        <CardContent>
